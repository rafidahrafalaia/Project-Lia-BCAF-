...
declare var $: any;
@Component({
  selector: 'app-list-returned-docust',
  templateUrl: './list-returned-docust.component.html',
  styleUrls: ['./list-returned-docust.component.css']
})
export class ListReturnedDocustComponent implements OnInit {
  public search:any = '';
  locked: any[] = [];
  userData : any;
  code:String;
  ...
  fetchData() {
    ...
    this.api.getKontrakReturnDocust().subscribe((d) => {
      this.temp = d;
      console.log(d);
      this.rows = d;
    });
