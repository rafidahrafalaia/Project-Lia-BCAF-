...
tdp2:this.categoryList2[13].isSelected,siup2:this.categoryList2[14].isSelected,ktpPengurus:this.categoryList2[15].isSelected,domisiliPT:this.categoryList2[16].isSelected,
approval:false,dokumenLain:this.categoryList2[17].isSelected,keterangan2:this.kontrak.keterangan,user:this.userData.name}).subscribe((kontrak)=>{
