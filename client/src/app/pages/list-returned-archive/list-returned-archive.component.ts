...
declare var $: any;
@Component({
  selector: 'app-list-returned-archive',
  templateUrl: './list-returned-archive.component.html',
  styleUrls: ['./list-returned-archive.component.css']
})
export class ListReturnedArchiveComponent implements OnInit {
  public search:any = '';
  locked: any[] = [];
  userData : any;
  code:String;
  ...
  fetchData() {
    ...
    this.api.getKontrakReturnArchive().subscribe((d) => {
      this.temp = d;
      console.log(d);
      this.rows = d;
    });
