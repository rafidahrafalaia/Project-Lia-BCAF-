...
export class BorrowComponent implements OnInit {
  ...
  fetchData() {
    ...
    this.api.getKontrakDocust().subscribe((d) => {
      this.temp = d;
      console.log(d);
      this.rows = d;
    });
  ...
  selectedRow(nomor){
    console.log(nomor) 
    this.api.setBorrow({ id:this.kontrak.id,nomor:nomor, recive:true,pengajuan:true,user:this.userData.name}).subscribe((kontrak)=>{
