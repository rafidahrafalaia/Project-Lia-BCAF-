...
@Component({
  selector: 'app-list-borrrow-archive',
  templateUrl: './list-borrrow-archive.component.html',
  styleUrls: ['./list-borrrow-archive.component.css']
})
export class ListBorrrowArchiveComponent implements OnInit {
  public search:any = '';
  locked: any[] = [];
  userData : any;
  code:String;
  ...
  fetchData() {
    ...
    this.api.getKontrakArchiveBorrow().subscribe((d) => {
      this.temp = d;
      console.log(d);
      this.rows = d;
    });
